...
python run_logic_el_gold.py \
--dataset_name lcquad \
--model_name pure_ctx_type \
--experiment_name exp_logic_lcquad_pure_ctx_type \
--num_epoch 30 \
...
--dataset_name qald9 \
--model_name pure_ctx_type \
--experiment_name exp_logic_qald_pure_ctx_type \
--num_epoch 30 \
--learning_rate 0.0001
...
from models.logic_el_gold import *
...
def get_qald_metrics(pred_, m_labels_, ques_, gold_file_name, topk=5):
    ...
    metrics = compute_metrics_top_k(benchmark=benchmark, predictions=predictions, limit=410, is_qald_gt=is_qald_gt,
                              eval='full')
